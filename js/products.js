...
const PRODUCTS = [
  ...
  {brand:'tuya',id:'ty_energy_meter',cat:'switch',tag:'ENERGY',tc:'gold',name:'Smart Energy Meter',model:'Tuya DAC21C Series',price:0,pd:'Contact for price',img:'powr3',desc:'DIN rail smart energy meter with LCD display. Bi-directional metering, daily and monthly stats. Perfect for generator monitoring in Lebanon.',specs:[['Display','LCD'],['Metering','Bi-directional'],['Install','DIN Rail'],['Monitor','V/A/W/kWh']]},
  ...
  {brand:'tuya',id:'ty_smart_plug',cat:'plug',tag:'MATTER',tc:'blue',name:'Matter Smart Plug EU 16A',model:'Tuya F1203-EU',price:0,pd:'Contact for price',img:'s26',desc:'Matter-certified smart plug. 16A max. Works with Alexa, Google, Apple HomeKit, SmartThings. Remote control, scheduling and power monitoring.',specs:[['Standard','Matter over Wi-Fi'],['Current','16A Max'],['Ecosystems','Alexa/Google/Apple/SmartThings'],['Monitor','Power (Optional)']]},
  {brand:'tuya',id:'ty_scene_switch',cat:'switch',tag:'',tc:'',name:'Smart Scene Switch',model:'Tuya PS162-W-EU',price:0,pd:'Contact for price',img:'wall_switch_1g',desc:'WiFi scene switch to trigger multiple automations with one tap. Two-way and multi-way control. 16A output.',specs:[['Protocol','Wi-Fi + Bluetooth'],['Output','16A'],['Control','Multi-way Wireless'],['Sensor','Proximity Screen']]},
